...
class CopyProductRulesListLoadQuery extends ListQueryResponse
{
    ...
    protected Collection $copyProductRules;
    ...
    public function __construct(RequestInterface $request, HttpResponse $response, array $data)
    {
        ...
        $this->copyProductRules = new Collection();
        ...
        if (isset($data['data']['data'])) {
            foreach ($data['data']['data'] as $result) {
              $this->copyProductRules[] = new CopyProductRule($result);
            }
        }
    }
     ...
     */
    public function getCopyProductRules() : Collection
    {
        return $this->copyProductRules;
    }
}
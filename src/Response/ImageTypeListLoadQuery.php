...
{
    /** @var \MerchantAPI\Collection|\MerchantAPI\Model\ImageType[] */
    ...
    public function __construct(RequestInterface $request, HttpResponse $response, array $data)
    {
        ...
        $this->imageTypes = new \MerchantAPI\Collection();
     ...
     * Get imageTypes.
     *
     * @return \MerchantAPI\Collection|\MerchantAPI\Model\ImageType[]
     */

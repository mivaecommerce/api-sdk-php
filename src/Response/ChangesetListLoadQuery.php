...
{
    /** @var \MerchantAPI\Collection|\MerchantAPI\Model\Changeset[] */
    ...
    public function __construct(RequestInterface $request, HttpResponse $response, array $data)
    {
        ...
        $this->changesets = new \MerchantAPI\Collection();
     ...
     * Get changesets.
     *
     * @return \MerchantAPI\Collection|\MerchantAPI\Model\Changeset[]
     */

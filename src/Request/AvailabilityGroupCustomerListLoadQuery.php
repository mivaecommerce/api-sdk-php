...
class AvailabilityGroupCustomerListLoadQuery extends CustomerListLoadQuery
{
    ...
    protected string $function = 'AvailabilityGroupCustomerList_Load_Query';
    ...
    {
        return new \MerchantAPI\Response\AvailabilityGroupCustomerListLoadQuery($this, $httpResponse, $data);
    }
}
...
class CopyProductRulesModuleUpdateAssigned extends Request
{
    ...
    protected string $function = 'CopyProductRulesModule_Update_Assigned';
    ...
    {
        return new \MerchantAPI\Response\CopyProductRulesModuleUpdateAssigned($this, $httpResponse, $data);
    }
}
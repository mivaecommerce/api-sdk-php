 ...
 */
class CopyProductRulesCustomFieldListLoadQuery extends ListQueryRequest
{
    /** @var string The request scope */
    protected string $scope = self::REQUEST_SCOPE_STORE;

    /** @var string The API function name */
    protected string $function = 'CopyProductRulesCustomFieldList_Load_Query';
    ...
    {
        return new \MerchantAPI\Response\CopyProductRulesCustomFieldListLoadQuery($this, $httpResponse, $data);
    }
}
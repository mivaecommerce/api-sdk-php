...
class PriceGroupQualifyingProductListLoadQuery extends ProductListLoadQuery
{
    ...
    protected string $function = 'PriceGroupQualifyingProductList_Load_Query';
    ...
    {
        return new \MerchantAPI\Response\PriceGroupQualifyingProductListLoadQuery($this, $httpResponse, $data);
    }
}
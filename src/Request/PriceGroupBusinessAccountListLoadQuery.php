...
class PriceGroupBusinessAccountListLoadQuery extends BusinessAccountListLoadQuery
{
    ...
    protected string $function = 'PriceGroupBusinessAccountList_Load_Query';
    ...
    {
        return new \MerchantAPI\Response\PriceGroupBusinessAccountListLoadQuery($this, $httpResponse, $data);
    }
}
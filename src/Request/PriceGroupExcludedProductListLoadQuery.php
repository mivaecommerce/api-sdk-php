...
class PriceGroupExcludedProductListLoadQuery extends ProductListLoadQuery
{
    ...
    protected string $function = 'PriceGroupExcludedProductList_Load_Query';
    ...
    {
        return new \MerchantAPI\Response\PriceGroupExcludedProductListLoadQuery($this, $httpResponse, $data);
    }
}